...
themes_path = string.format("%s/.config/awesome/themes/", os.getenv("HOME"))
local themes = {
	"blackburn", -- 1
	"copland", -- 2
	"dremora", -- 3
...
local chosen_theme = themes_path .. themes[11] .. "/theme.lua"
...
awful.key({ modkey }, "f",     function () awful.util.spawn("pcmanfm-qt") end,
